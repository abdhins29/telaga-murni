	...
	<div class="card shadow mt-3 mb-3">
      ...
      <div class="table-responsive">
            ...
            <th colspan="2">Aksi</th>
				...
				include ('../config/koneksi.php');
				$no = 1;
				$query = mysqli_query($konek, "SELECT * FROM tbl_pengembalian a LEFT JOIN tbl_transaksi b ON a.kd_transaksi=b.kd_transaksi LEFT JOIN tbl_pelanggan c ON b.kd_pelanggan=c.kd_pelanggan");
            ...
            <td><a href="editkembali.php?kd=<?php echo $data['kd_kembali']; ?>"><i class="btn btn-success btn-sm"><span class="fas fa-edit"></span></i></a></td>
            <td><a href="hapuskembali.php?kd=<?php echo $data['kd_kembali']; ?>"><i class="btn btn-danger btn-sm"><span class="fas fa-trash"></span></i></a></td>
					</tr>
				</tbody>
				<?php 
				}
